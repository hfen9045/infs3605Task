...
public class year2_Term1 extends Fragment {
    ...
    static year2_RecyclerViewAdapter adapter;
    static year2_RecyclerViewAdapter adapter2;
    static year2_RecyclerViewAdapter adapter3;
    static year2_RecyclerViewAdapter adapter4;
    static year2_RecyclerViewAdapter adapter5;
    static year2_RecyclerViewAdapter adapter6;
    ...
    private year2_Term1.OnFragmentInteractionListener mListener;
    ...
    public static year2_Term1 newInstance(String param1, String param2) {
        year2_Term1 fragment = new year2_Term1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.activity_term1, container, false);
        ...
        adapter = new year2_RecyclerViewAdapter(getActivity(), courseList);
        ...
        adapter3 = new year2_RecyclerViewAdapter(getActivity(), courseList3);
        ...
        adapter2 = new year2_RecyclerViewAdapter(getActivity(), courseList2);
        ...
        adapter4 = new year2_RecyclerViewAdapter(getActivity(), courseList4);
        ...
        adapter5 = new year2_RecyclerViewAdapter(getActivity(), courseList5);
        ...
        adapter6 = new year2_RecyclerViewAdapter(getActivity(), courseList6);
        ...
        enrolButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dbHelper.getRemainingPECourses()<0){
                    int pe = dbHelper.getRemainingPECourses();

                    int ge = dbHelper.getRemainingGECourses();
                    int fe = dbHelper.getRemainingFECourses();
                    int pfe = fe + pe;
                    int pge = ge + pfe;
                    ...
                    int pfe1 = fe+pe;
                    if(pfe>=0){
                        String remainingDesc = dbHelper.getRemainingCoreCourses() + " core(s) \n" + dbHelper.getRemainingBusCoreCourses() + " Business core(s) \n" + "0" + " Prescribed elective(s) \n" + pfe + " Free elective(s) \n" + dbHelper.getRemainingGECourses() + " General education(s)";
                        remainingCourses.setText(remainingDesc);
                    }else if(pge>=0){
                        String remainingDesc = dbHelper.getRemainingCoreCourses() + " core(s) \n" + dbHelper.getRemainingBusCoreCourses() + " Business core(s) \n" + "0" + " Prescribed elective(s) \n" + "0" + " Free elective(s) \n" + pge + " General education(s)";
                        remainingCourses.setText(remainingDesc);
                    }else{
                        String remainingDesc = dbHelper.getRemainingCoreCourses() + " core(s) \n" + dbHelper.getRemainingBusCoreCourses() + " Business core(s) \n" + pge + " Prescribed elective(s) \n" + "0" + " Free elective(s) \n" + "0" + " General education(s)";
                        remainingCourses.setText(remainingDesc);
                    }
