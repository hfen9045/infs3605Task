...
public class year3_Term1 extends Fragment {
    ...
    private year3_Term1.OnFragmentInteractionListener mListener;
    ...
    public static year3_Term1 newInstance(String param1, String param2) {
        year3_Term1 fragment = new year3_Term1();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof year3_Term1.OnFragmentInteractionListener) {
            mListener = (year3_Term1.OnFragmentInteractionListener) context;
        } else {
