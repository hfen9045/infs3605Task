...
public class year1_Term1 extends Fragment {
    ...
    private year1_Term1.OnFragmentInteractionListener mListener;
    ...
    public static year1_Term1 newInstance(String param1, String param2) {
        year1_Term1 fragment = new year1_Term1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView4.setDrawingCacheQuality(View.DRAWING_CACHE_QUALITY_HIGH);
