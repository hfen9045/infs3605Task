...
public class year2_Term2 extends Fragment {
    ...
    private year2_Term2.OnFragmentInteractionListener mListener;
    ...
    public static year2_Term2 newInstance(String param1, String param2) {
        year2_Term2 fragment = new year2_Term2();
