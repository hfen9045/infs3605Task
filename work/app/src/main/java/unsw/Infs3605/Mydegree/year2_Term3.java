...
public class year2_Term3 extends Fragment {
    ...
    private year2_Term3.OnFragmentInteractionListener mListener;
    ...
    public static year2_Term3 newInstance(String param1, String param2) {
        year2_Term3 fragment = new year2_Term3();
