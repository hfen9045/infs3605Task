...
public class year3_Term3 extends Fragment {
    ...
    private year3_Term3.OnFragmentInteractionListener mListener;
    ...
    public static year3_Term3 newInstance(String param1, String param2) {
        year3_Term3 fragment = new year3_Term3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enrolButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int remainingPE = dbHelper.getRemainingPECourses();
                int remainingElective = dbHelper.getRemainingFECourses();
                int remainingGen = dbHelper.getRemainingGECourses();
                final int total = remainingCore + remainingElective + remainingGen+remainingBC+remainingPE;
...
//                        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof year3_Term3.OnFragmentInteractionListener) {
            mListener = (year3_Term3.OnFragmentInteractionListener) context;
        } else {
